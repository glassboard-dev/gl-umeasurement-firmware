...
#define USB_DEVICE_VID (0xDEADU)
#define USB_DEVICE_PID (0xBEEFU)
...
#define USB_HID_GENERIC_IN_BUFFER_LENGTH (1024)
#define USB_HID_GENERIC_OUT_BUFFER_LENGTH (USB_HID_GENERIC_IN_BUFFER_LENGTH)

#define USB_HID_GENERIC_ENDPOINT_COUNT (3U)
#define USB_HID_GENERIC_INTERFACE_INDEX (0U)

#define USB_HID_GENERIC_INT_ENDPOINT_IN (1U)
#define USB_HID_GENERIC_INT_ENDPOINT_OUT (2U)
#define USB_HID_GENERIC_ISO_ENDPOINT_IN (3U)
...
#define HS_HID_GENERIC_ISO_IN_PACKET_SIZE (1024U)
#define HS_HID_GENERIC_ISO_IN_INTERVAL (0x01U)
